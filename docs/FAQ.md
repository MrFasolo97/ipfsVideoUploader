...
Contact us in the DTube [Discord server](https://discord.gg/QsBnrwqsSV). Include screenshot of the console output from your browser whenever applicable.
...
As for our hosting service (accessing through webapp or desktop app), please contact us in our [Discord server](https://discord.gg/QsBnrwqsSV) with the transaction ID of your payment if the issue persists after the required confirmation times.
...
If the issue still persists, please contact us on our [Discord server](https://discord.gg/QsBnrwqsSV).
...
Currently, the uploader does not have this functionality yet. Please reach out to `@fasolo97` on our [Discord server](https://discord.gg/QsBnrwqsSV) for now.
